...
list_rules = (
    ...
    base.APIRule(
        ...
        check_str=("role:reader or rule:is_admin or rule:is_observer"),
    ...
    base.APIRule(
        ...
        check_str=("(role:reader and system_scope:all) or (role:reader and (project_id:%(node.owner)s or project_id:%(node.lessee)s)) or rule:is_admin or rule:is_observer"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or ((role:member or role:_member_) and (project_id:%(node.owner)s or project_id:%(node.lessee)s)) or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or ((role:member or role:_member_) and project_id:%(node.owner)s) or (role:admin and project_id:%(node.lessee)s) or (role:manager and project_id:%(node.lessee)s) or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or (role:admin and project_id:%(node.owner)s) or (role:manager and project_id:%(node.owner)s) or rule:is_admin or rule:is_observer"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or (role:admin and project_id:%(node.owner)s) or (role:manager and project_id:%(node.owner)s) or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or ((role:member or role:_member_) and project_id:%(node.owner)s) or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("(role:reader and system_scope:all) or (role:reader and (project_id:%(node.owner)s or project_id:%(node.lessee)s)) or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("(role:admin and system_scope:all) or (role:admin and project_id:%(node.owner)s) or (role:manager and project_id:%(node.owner)s) or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("(role:member or role:_member_) and system_scope:all or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or (role:admin and project_id:%(node.owner)s) or (role:manager and project_id:%(node.owner)s) or (role:admin and project_id:%(node.lessee)s) or (role:manager and project_id:%(node.lessee)s) or rule:is_admin"),
    ...
    base.APIRule(
        ...
        check_str=("(role:reader and system_scope:all) or (role:reader and project_id:%(allocation.owner)s) or rule:is_admin or rule:is_observer"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or (role:member or role:_member_) or rule:is_admin and is_admin_project:True"),
    ...
    base.APIRule(
        ...
        check_str=("(role:member or role:_member_) and system_scope:all or rule:is_admin and is_admin_project:True"),
    ...
    base.APIRule(
        ...
        check_str=("((role:member or role:_member_) and system_scope:all) or ((role:member or role:_member_) and project_id:%(allocation.owner)s) or rule:is_admin"),

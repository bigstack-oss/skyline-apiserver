...
list_rules = (
    ...
    base.APIRule(
        ...
        check_str=("True:%(enforce_new_defaults)s and (role:member or role:_member_) or rule:admin_or_creator"),
    ...
    base.APIRule(
        name="containers:get",
        check_str=("True:%(enforce_new_defaults)s and (role:member or role:_member_) or rule:all_but_audit"),
    ...
    base.APIRule(
        name="order:get",
        check_str=("True:%(enforce_new_defaults)s and rule:order_project_member or rule:all_users and project_id:%(target.order.project_id)s"),
    ...
    base.APIRule(
        name="order:delete",
        check_str=("True:%(enforce_new_defaults)s and rule:order_project_member or rule:admin and project_id:%(target.order.project_id)s"),
    ...
    base.APIRule(
        name="quotas:get",
        check_str=("True:%(enforce_new_defaults)s and role:reader or rule:all_users"),
    ...
    base.APIRule(
        ...
        check_str=("True:%(enforce_new_defaults)s and rule:system_reader or rule:service_admin"),
    ...
    base.APIRule(
        ...
        check_str=("True:%(enforce_new_defaults)s and rule:system_admin or rule:service_admin"),

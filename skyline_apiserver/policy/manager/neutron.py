...
list_rules = (
    ...
    base.APIRule(
        ...
        check_str=("(rule:admin_only or ((role:member or role:_member_) and project_id:%(project_id)s)) or rule:ext_parent_owner"),
    ...
    base.APIRule(
        ...
        check_str=("rule:admin_only or ((role:member or role:_member_) and project_id:%(project_id)s)s"),

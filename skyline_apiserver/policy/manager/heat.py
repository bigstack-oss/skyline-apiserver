...
list_rules = (
    ...
    base.Rule(
        ...
        check_str=("(role:reader and system_scope:all) or (role:reader and project_id:%(project_id)s) or rule:deny_stack_user"),
        description="No description",
    ),
    base.Rule(
        name="cloudformation:CreateStack",
        check_str=("(role:admin and system_scope:all) or ((role:member or role:_member_) and project_id:%(project_id)s) or rule:deny_stack_user"),
        description="No description",
    ),
    base.Rule(
    ...
    base.Rule(
        ...
        check_str=("(role:reader and system_scope:all) or (role:reader and project_id:%(project_id)s) or (role:heat_stack_user and project_id:%(project_id)s) or rule:deny_stack_user"),
        description="No description",
    ),
    base.Rule(
    ...
    base.Rule(
        name="service:index",
        check_str=("role:reader and system_scope:all or rule:context_is_admin"),
        description="No description",
    ),
    base.APIRule(
        name="actions:action",
    ...
    base.APIRule(
        name="stacks:lookup",
        check_str=("(role:reader and system_scope:all) or (role:reader and project_id:%(project_id)s) or (role:heat_stack_user and project_id:%(project_id)s) or rule:allow_everybody"),
